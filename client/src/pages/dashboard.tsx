      ...
      <main className="ml-96 pt-16 min-h-screen relative z-20">
        <div className="p-8">
          <div className="max-w-7xl mx-auto">
            {/* Header */}
            <div className="bg-slate-900/20 backdrop-blur-sm border border-cyan-500/30 rounded-2xl p-8 mb-8 shadow-2xl shadow-cyan-500/20">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
              <Card className="bg-slate-900/30 backdrop-blur-sm border-cyan-500/20 shadow-lg shadow-cyan-500/10">
                <CardContent className="p-6">
                  <div className="flex items-center justify-between mb-4">
                    <h3 className="cinzel text-lg font-bold text-white">Study Time Today</h3>
              ...
              <Card className="bg-slate-900/30 backdrop-blur-sm border-blue-500/20 shadow-lg shadow-blue-500/10">
                <CardContent className="p-6">
                  <div className="flex items-center justify-between mb-4">
                    <h3 className="cinzel text-lg font-bold text-white">This Week</h3>
